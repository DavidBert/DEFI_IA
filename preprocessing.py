...
if __name__=='__main__':
    ...
    X_station_data_train = X_station_train(data_path+"/X_station_train.csv", journées_train)
    X_station_data_test = X_station_test(data_path+"/X_station_test.csv")
    ...
    Y_data_train = Y_station(data_path+"/Y_train.csv", journées_train)
